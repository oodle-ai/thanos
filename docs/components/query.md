...
In short, it gathers the data needed to evaluate the query from underlying [StoreAPIs](https://github.com/oodle-ai/thanos/blob/main/pkg/store/storepb/rpc.proto), evaluates the query and returns the result.
